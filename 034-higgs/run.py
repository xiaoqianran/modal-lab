...
VOL_OUT = "modal-lab-higgs-outputs"
DEFAULT_GPU = "L40S"
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="034 Higgs Audio v2 on Modal (L40S · 收官)")
    ...
    sm.add_argument("--kind", default="en", choices=["en", "expressive"])
