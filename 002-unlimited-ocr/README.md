...
| A100 SXM 80 GB | 32 | 116.112–137.343 | 1,155.969–1,356.007 | 45.08–54.10% / 67–73% | FlashAttention 3 |

H100 快 15.35%；按 2026-07-30 Modal 公示单价只计算 GPU，RTX 的单页
成本低约 11.47%。A100 80GB c32 的 GPU 单页成本在 $0.000303–$0.000359
间波动：快节点比 RTX 低 12.9%，慢节点反而高约 3.0%。`A100-40GB`
请求还可能被 Modal 免费升级为 80GB PCIe/SXM，详细 c16/c24/c32、
冷启动、功耗、复验和成本数据见 [仓库 GPU 对比](../GPU_COMPARISON.md)。
