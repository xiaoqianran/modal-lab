...
| 你实际会跑的 | 大概单次 GPU |
|---|---:|
| **默认：Qwen+LoRA @ RTX-PRO-6000** | **大约 $0.3–2** |
| 全量 80B 多卡 | **$10+**（**别默认开**） |
...
| 手段 | VRAM 量级 | 说明 |
|---|---|---|
| bf16 原版 | ~40–48GB+ | Modal：L40S 紧 / RTX-PRO-6000 稳 |
...
默认稳妥         Qwen · bf16 · RTX-PRO-6000 · 官方默认分辨率
可尝试           Qwen · bf16 · L40S
别碰（除非有钱） full 80B · H100:4 / RTX-PRO-6000:4
```
...
| Qwen bf16 | RTX-PRO-6000 | ~2.50 | 5–15 min | ~$0.20–0.65 |
...
| RTX-PRO-6000 | 80GB | bf16 Qwen 稳妥（稍贵） |
...
1. 先 **bf16 @ L40S** 或 **RTX-PRO-6000** 验证 panogen 通路（一次，接受 ~$0.5 级）  
...
# 或
python main.py 008 smoke --backend qwen --gpu RTX-PRO-6000
```
