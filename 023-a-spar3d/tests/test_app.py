"""023-a app.py 的本地 CLI / planning 测试；不连接 Modal。"""
...
class TestCli(unittest.TestCase):
    def test_status(self):
        ...
        self.assertEqual(status["official_model"], "stabilityai/stable-point-aware-3d")
    ...
    def test_default_smoke(self):
        ...
        self.assertFalse(plan["low_vram_mode"])

    def test_pro6000_and_low_vram(self):
        plan = app.smoke_plan(
            app.parse_cli(
                [
                    "smoke",
        ...
        self.assertTrue(plan["low_vram_mode"])
